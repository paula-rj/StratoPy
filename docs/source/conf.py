...
project = "StratoPy"
copy_right = "2021, Paula Romero, Georgynio Rosales, Jose Robledo, Julian Villa, Juan Cabral"
author = (
    "Paula Romero, Georgynio Rosales, Jose Robledo, Julian Villa, Juan Cabral"
)
