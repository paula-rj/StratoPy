...
def recorte(data_path,x0 = -555469.8930323641, y0 = 0.0):
        ...
        #lon = -80. -> x0
    """
    Funcion que recorta la una imagen tipo CMI de GOES (formato netCDF).
    Parameters
    ----------
    data_path: str. 
    ...
    if int(banda)==3:
        image = muestreo(x=np.arange(img_rows), y=np.arange(img_cols), z=image, esc=0.5)
        psize= 2000
        N = 5424 #esc da 1
    ...
    Ny = int(filas/esc) #numero de puntos del recorte en y
...
# %%
rec03 = recorte("data/GOES16/OR_ABI-L2-CMIPF-M3C03_G16_s20190021800363_e20190021811129_c20190021811205.nc")
rec03
# rec07 = recorte("data/GOES16/OR_ABI-L2-CMIPF-M3C07_G16_s20190021800363_e20190021811141_c20190021811202.nc")
# rec13 = recorte("data/GOES16/OR_ABI-L2-CMIPF-M3C13_G16_s20190021800363_e20190021811141_c20190021811221.nc")
